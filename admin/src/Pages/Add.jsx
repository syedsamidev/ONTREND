  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='e.g Men sweatshirt' required/>
      </div>
      ...
      <div>
        ...
        <div className='flex gap-3'>
          ...
          <div onClick={()=>setSizes(prev => prev.includes("XLL") ? prev.filter(item => item !== "XLL") : [...prev, "XLL"])}>
            <p className={`${sizes.includes("XLL") ? "bg-blue-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>XLL</p>
          </div>
        </div>
      </div>
